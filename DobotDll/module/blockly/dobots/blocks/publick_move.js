...
Blockly.Python['dobot_setr'] = function(block) {
  ...
  // TODO: Assemble Python into code variable.
  var code = 'current_pose = dType.GetPose(api)\ndType.SetPTPCmdEx(api, 1, current_pose[0], current_pose[1], current_pose[2], '+value_zbias+', 1)\n';
  return code;
};
...
Blockly.Blocks['dobot_gripper'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([[Blockly.Msg.DOBOT_GripperPROHIBIT, "0"], [Blockly.Msg.DOBOT_GripperOff, "2"], [Blockly.Msg.DOBOT_GripperON, "1"]]), "io");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(330);
...
Blockly.Blocks['dobot_get_joint_angle'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([[Blockly.Msg.DOBOT_joint1, "5"], [Blockly.Msg.DOBOT_joint2, "6"], [Blockly.Msg.DOBOT_joint3, "7"], [Blockly.Msg.DOBOT_joint4, "8"],[Blockly.Msg.DOBOT_covery, "0"]]), "value");
    this.setInputsInline(true);
    this.setOutput(true, "Number");
    this.setColour(330);
...
Blockly.Python['dobot_delaytime'] = function(block) {
  ...
  // TODO: Assemble Python into code variable.
  var code = 'dType.dSleep('+value_time*1000+')\n';
  return code;
};
