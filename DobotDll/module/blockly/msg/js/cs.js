...
Blockly.Msg.DOBOT_ON = "Zapnuto";
Blockly.Msg.DOBOT_OFF = "Vypnuto";
Blockly.Msg.Dobot_Speed = "Rychlost";
Blockly.Msg.Dobot_DELTAPULSE = "Delta Puls"
Blockly.Msg.DOBOT_ENABELD = "Stav";
Blockly.Msg.DOBOT_GripperON = "Uchop";
Blockly.Msg.DOBOT_GripperOff = "Pusť";
Blockly.Msg.DOBOT_GripperPROHIBIT = "Disable";											  
Blockly.Msg.DOBOT_BASEIC_HOME = "Domů";
Blockly.Msg.DOBOT_BASEIC_HOME_TOOLTIP = "Domů";
Blockly.Msg.DOBOT_BASEIC_TIME = "Získej čas";
Blockly.Msg.DOBOT_BASEIC_TIME_TOOLTIP = "Získej čas, jednotky: s";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE = "Vyber koncový efektor";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_TOOLTIP = "Vyber koncový efektor";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_SUCTIONCAP = "Přísavka";
...
Blockly.Msg.DOBOT_BASEIC_SETENDEFFECTORPARAMS = "Nastav parametry koncového efektoru"; //parekr add 2018 9 8
Blockly.Msg.DOBOT_BASEIC_SETENDEFFECTORPARAMS_TOOLTIP = "Nastav parametry koncového efektoru";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT = "Nastav výšku skoku";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT_TOOLTIP = "Nastav výšku skoku";
Blockly.Msg.DOBOT_SETR = "Otoč osu R";
Blockly.Msg.DOBOT_SETR_TOOLTIP = "Otoč osu R";
Blockly.Msg.DOBOT_SUCTIONCAP = "Přísavka";
Blockly.Msg.DOBOT_SUCTIONCAP_TOOLTIP = "Přísavka";
Blockly.Msg.DOBOT_GRIPPER = "Gripper";
Blockly.Msg.DOBOT_GRIPPER_TOOLTIP = "Gripper";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE= "Získej současné souřadnice";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE_TOOLTIP = "Získej současné souřadnice";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE= "Získej úhel kloubu";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE_TOOLTIP = "Získej úhel kloubu";
Blockly.Msg.DOBOT_DELAYTIME= "Počkej";
Blockly.Msg.DOBOT_DELAYTIME_TOOLTIP = "Počkej";
Blockly.Msg.DOBOT_MOTOR = "Motor"
Blockly.Msg.DOBOT_Value = "hodnota";
Blockly.Msg.DOBOT_FREQUENCY = "frekvence";
Blockly.Msg.DOBOT_DUTYCYCLE = "střída signálu";

Blockly.Msg.DOBOT_joint1 = "Kloub 1";
Blockly.Msg.DOBOT_joint2 = "Kloub 2";
Blockly.Msg.DOBOT_joint3 = "Kloub 3";
Blockly.Msg.DOBOT_joint4 = "Kloub 4";
Blockly.Msg.DOBOT_covery = "L";
Blockly.Msg.DOBOT_xBias = "souřadnice X";
Blockly.Msg.DOBOT_yBias = "souřadnice Y";
Blockly.Msg.DOBOT_zBias = "souřadnice Z";
Blockly.Msg.DOBOT_j1 = "Kloub 1";
Blockly.Msg.DOBOT_j2 = "Kloub 2";
Blockly.Msg.DOBOT_j3 = "Kloub 3";
Blockly.Msg.DOBOT_j4 = "Kloub 4";
Blockly.Msg.DOBOT_j1Velocity = "Rychlost kloubu 1";
Blockly.Msg.DOBOT_j2Velocity = "Rychlost kloubu 2";
Blockly.Msg.DOBOT_j3Velocity = "Rychlost kloubu 3";
Blockly.Msg.DOBOT_j4Velocity = "Rychlost kloubu 4";
Blockly.Msg.DOBOT_j1Acceleration = "Zrychlení kloubu 1";
Blockly.Msg.DOBOT_j2Acceleration = "Zrychlení kloubu 2";
Blockly.Msg.DOBOT_j3Acceleration = "Zrychlení kloubu 3";
Blockly.Msg.DOBOT_j4Acceleration = "Zrychlení kloubu 4";
Blockly.Msg.DOBOT_height = "Výška";
Blockly.Msg.DOBOT_lVelocity = "Rychlost osy L";
Blockly.Msg.DOBOT_lAcceleration = "Zrychlení osy L";
Blockly.Msg.DOBOT_value = "Hodnota";
Blockly.Msg.DOBOT_type = "Typ";

Blockly.Msg.DOBOT_THRESHOLD = "Hranice";
Blockly.Msg.DOBOT_ANGLEUNIT = "Stupeň";
Blockly.Msg.DOBOT_SETLOSTSTEPPARAMS_TOOLTIP = "Nastav parametry ztraceného kroku";
Blockly.Msg.DOBOT_SETLOSTSTEPCMD_TOOLTIP = "Zkontroluj ztracený krok";
Blockly.Msg.Dobot_DISTANCE = "Vzdálenost";
Blockly.Msg.Dobot_IO_INPUT_3V = "Vstup 3.3V";
Blockly.Msg.Dobot_IO_INPUT_5V = "Vstup 5V";
Blockly.Msg.Dobot_IO_ADC = "Vstup AD";
Blockly.Msg.Dobot_IO_OUTPUT_3V = "Výstup 3.3V";
Blockly.Msg.Dobot_IO_OUTPUT_5V = "Výstup 5V";
Blockly.Msg.Dobot_IO_OUTPUT_12V = "Výstup 12V";
Blockly.Msg.Dobot_IO_PWM = "Výstup PWM";
Blockly.Msg.DOBOT_ACCELERATION = "Zrychlení";
Blockly.Msg.DOBOT_VELOCITY = "Rychlost";

//2017-07-03
Blockly.Msg.DOBOT_SET_JOINT_SPEED = "Nastav rychlost kloubu";
Blockly.Msg.DOBOT_SET_JOINT_SPEED_TOOLTIP = "Nastav rychlost kloubu";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED = "Nastav parametry pohybu";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED_TOOLTIP = "Nastav parametry pohybu";
Blockly.Msg.DOBOT_VELOCITY_RATIO = "Rychlost";
Blockly.Msg.DOBOT_ACCELERATION_RATIO = "Zrychlení";
Blockly.Msg.DOBOT_SET_MOTOR = "Nastav rychlost motoru"
Blockly.Msg.DOBOT_SET_MOTOR_TOOLTIP = "Nastav rychlost motoru"
Blockly.Msg.DOBOT_SET_MOTORS = "Nastav rychlost a vzdálenost motoru"
Blockly.Msg.DOBOT_SET_MOTORS_TOOLTIP = "Nastav rychlost a vzdálenost motoru"
Blockly.Msg.DOBOT_GOTO = "Přesuň se na";
Blockly.Msg.DOBOT_GOTO_TOOLTIP = "Přesuň se na";
Blockly.Msg.DOBOT_JUMPTO = "Skoč na";
Blockly.Msg.DOBOT_JUMPTO_TOOLTIP = "Skoč na";
Blockly.Msg.DOBOT_MOVE = "Jdi o";
Blockly.Msg.DOBOT_MOVE_TOOLTIP = "Jdi o";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE = "Nastav úhel kloubu";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE_TOOLTIP = "Nastav úhel kloubu";
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR = "Nastav fotoelektrický senzor";
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR_TOOLTIP = "Nastav fotoelektrický senzor";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR = "Přečti fotoelektrický senzor";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR_TOOLTIP = "Zjistí, zda se před senzorem nachází nějaký objekt. Vrací 1 - Objekt detekován, nebo 0 - Objekt nedetekován.";
Blockly.Msg.DOBOT_SET_COLORSENEOR= "Nastav senzor barev";
Blockly.Msg.DOBOT_SET_COLORSENEOR_TOOLTIP = "Nastav senzor barev";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "Zjisti barvu";
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "Zjistí, jaké složky barev daný objekt obsahuje (červenou, zelenou, modrou). Pokud složku detekuje vrátí 1, jinak vrátí 0.";
Blockly.Msg.DOBOT_SET_CONVEYOR = "Nastav pásový dopravník"
Blockly.Msg.DOBOT_SET_CONVEYOR_TOOLTIP = "Nastav pásový dopravník"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL = "Nastav kolejnici"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL_TOOLTIP = "Nastav kolejnici"
Blockly.Msg.DOBOT_SETL = "Přesuň kolejnici na";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "Přesuň kolejnici na";
Blockly.Msg.DOBOT_SET_L_SPEED = "Nastav rychlost kolejnice";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "Nastav rychlost kolejnice";
Blockly.Msg.DOBOT_POWER = "Síla";
Blockly.Msg.DOBOT_LASER = "Laser";
Blockly.Msg.DOBOT_LASER_TOOLTIP = "Laser";
Blockly.Msg.DOBOT_SET_OUTPUT12V = "Nastav 12V výstup   EIO";
Blockly.Msg.DOBOT_SET_OUTPUT12V_TOOLTIP = "Nastav 12V výstup";
Blockly.Msg.DOBOT_SET_OUTPUT= "Nastav úroveň výstupu   EIO";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "Nastav úroveň výstupu";
Blockly.Msg.DOBOT_GET_INPUT_EIO= "Získej úroveň vstupu   EIO";
Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "Získej úroveň vstupu";
Blockly.Msg.DOBOT_SET_PWM = "Nastav PWM výstup   EIO";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "Nastav PWM výstup";
Blockly.Msg.DOBOT_GET_PWM = "Získej PWM vstup   EIO";
Blockly.Msg.DOBOT_GET_PWM_TOOLTIP = "Získej PWM vstupt";
Blockly.Msg.DOBOT_GET_ADC = "Získej AD vstup   EIO";
Blockly.Msg.DOBOT_GET_ADC_TOOLTIP = "Získej AD vstup";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING= "Nastav Multiplexování IO";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING_TOOLTIP = "Nastav Multiplexování IO";

//2017-09-27
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED = "Nastav rychlost souřadnic";
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED_TOOLTIP = "Nastav rychlost souřadnic";

//2018-04-21
Blockly.Msg.DOBOT_SET_OUTPUT5V = "Nastav 5V výstup   EIO";
Blockly.Msg.DOBOT_SET_OUTPUT5V_TOOLTIP = "Nastav 5V výstup";
...
Blockly.Msg.DOBOT_VERSION = "Verze";
