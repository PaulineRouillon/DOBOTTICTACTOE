...
Blockly.Msg.Dobot_Speed = "Velocita";
Blockly.Msg.Dobot_DELTAPULSE = "DeltaPulse"
Blockly.Msg.DOBOT_ENABELD = "Abilitato";
Blockly.Msg.DOBOT_GripperON = "Pinza";
Blockly.Msg.DOBOT_GripperOff = "Rilascia";
Blockly.Msg.DOBOT_GripperPROHIBIT = "Disable";											  
Blockly.Msg.DOBOT_BASEIC_HOME = "Home";
Blockly.Msg.DOBOT_BASEIC_HOME_TOOLTIP = "Home";
Blockly.Msg.DOBOT_BASEIC_TIME = "PrendiTempo";
Blockly.Msg.DOBOT_BASEIC_TIME_TOOLTIP = "PrendiTempo, unità:s";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE = "ScegliEndEffector";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_TOOLTIP = "Scegli End Effector";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_SUCTIONCAP = "Ventosa";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_GRIPPER = "Pinza";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_LASER = "Laser";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_PEN = "Penna";
Blockly.Msg.DOBOT_BASEIC_SETENDEFFECTORPARAMS = "Imposta parametri End Effector"; //parekr add 2018 9 8
Blockly.Msg.DOBOT_BASEIC_SETENDEFFECTORPARAMS_TOOLTIP = "Imposta parametri End Effector";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT = "ImpostaAltezzaJump";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT_TOOLTIP = "Imposta altezza Jump";
Blockly.Msg.DOBOT_SETR = "ImpostaR";
Blockly.Msg.DOBOT_SETR_TOOLTIP = "Imposta R";
Blockly.Msg.DOBOT_SUCTIONCAP = "Ventosa";
Blockly.Msg.DOBOT_SUCTIONCAP_TOOLTIP = "Ventosa";
Blockly.Msg.DOBOT_GRIPPER = "Pinza";
Blockly.Msg.DOBOT_GRIPPER_TOOLTIP = "Pinza";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE= "PrendiCoordinateCorrenti";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE_TOOLTIP = "Prendi coordinate correnti";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE= "PrendiAngoloGiunto";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE_TOOLTIP = "Prendi angolo giunto";
Blockly.Msg.DOBOT_DELAYTIME= "Ritardo";
Blockly.Msg.DOBOT_DELAYTIME_TOOLTIP = "Ritardo";
Blockly.Msg.DOBOT_MOTOR = "Motore"
Blockly.Msg.DOBOT_Value = "valore";
Blockly.Msg.DOBOT_FREQUENCY = "frequenza";
