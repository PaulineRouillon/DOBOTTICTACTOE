...
Blockly.Msg.MATH_ROUND_OPERATOR_ROUND = "舍入";
...
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "输入文本并显示提示消息";
...
Blockly.Msg.DOBOT_ON = "开";
Blockly.Msg.DOBOT_OFF = "关";
Blockly.Msg.Dobot_Speed = "速度";
Blockly.Msg.Dobot_DELTAPULSE = "增量脉冲"
Blockly.Msg.DOBOT_ENABELD = "使能控制";
Blockly.Msg.DOBOT_GripperON = "闭合";
Blockly.Msg.DOBOT_GripperOff = "张开";
Blockly.Msg.DOBOT_GripperPROHIBIT = "禁止";
Blockly.Msg.DOBOT_BASEIC_HOME = "回零";
Blockly.Msg.DOBOT_BASEIC_HOME_TOOLTIP = "让机械臂码盘回零";
Blockly.Msg.DOBOT_BASEIC_TIME = "获取时间";
Blockly.Msg.DOBOT_BASEIC_TIME_TOOLTIP = "获取当前时间，以秒为单位";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE = "选择夹具";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_TOOLTIP = "选择末端夹具的类型";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_SUCTIONCAP = "吸盘";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_GRIPPER = "手爪";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_LASER = "激光";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_PEN = "笔";
Blockly.Msg.DOBOT_BASEIC_SETENDEFFECTORPARAMS = "设置末端坐标偏移量";//parekr add 2018 9 8
Blockly.Msg.DOBOT_BASEIC_SETENDEFFECTORPARAMS_TOOLTIP = "设置末端坐标偏移参数";
Blockly.Msg.DOBOT_SET_JOINT_SPEED_TOOLTIP = "设置每一个轴的速度和加速度";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED = "设置线性速度";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED_TOOLTIP = "设置运行的线性速度和加速度";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT = "设置门型高度";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT_TOOLTIP = "设置跳转运行的高度";
Blockly.Msg.DOBOT_GOTO = "移动到点";
Blockly.Msg.DOBOT_GOTO_TOOLTIP = "移动到某一点";
Blockly.Msg.DOBOT_JUMPTO = "门型移动到某一点";
Blockly.Msg.DOBOT_JUMPTO_TOOLTIP = "门型移动到某一点";
Blockly.Msg.DOBOT_MOVE = "相对移动";
Blockly.Msg.DOBOT_MOVE_TOOLTIP = "相对移动某一点";
Blockly.Msg.DOBOT_SETR = "设置末端角度";
Blockly.Msg.DOBOT_SETR_TOOLTIP = "相对改变末端的角度";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE = "按照角度来移动";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE_TOOLTIP = "按照角度移动机械臂";
Blockly.Msg.DOBOT_SUCTIONCAP = "吸盘";
Blockly.Msg.DOBOT_SUCTIONCAP_TOOLTIP = "吸盘控制";
Blockly.Msg.DOBOT_GRIPPER = "手爪";
Blockly.Msg.DOBOT_GRIPPER_TOOLTIP = "爪控制";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE= "获取目前的坐标值";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE_TOOLTIP = "获取目前的坐标值";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE= "获取目前的角度值";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE_TOOLTIP = "获取目前的角度值";
Blockly.Msg.DOBOT_DELAYTIME= "延时";
Blockly.Msg.DOBOT_DELAYTIME_TOOLTIP = "延时执行";
Blockly.Msg.DOBOT_MOTOR = "电机"
Blockly.Msg.DOBOT_Value = "获取";
Blockly.Msg.DOBOT_FREQUENCY = "频率";
Blockly.Msg.DOBOT_DUTYCYCLE = "占空比";

Blockly.Msg.DOBOT_joint1 = "关节1";
Blockly.Msg.DOBOT_joint2 = "关节2";
Blockly.Msg.DOBOT_joint3 = "关节3";
Blockly.Msg.DOBOT_joint4 = "关节4";
Blockly.Msg.DOBOT_covery = "滑轨";
Blockly.Msg.DOBOT_xBias = "X偏移値";
Blockly.Msg.DOBOT_yBias = "Y偏移値";
Blockly.Msg.DOBOT_zBias = "Z偏移値";
Blockly.Msg.DOBOT_j1 = "关节1";
Blockly.Msg.DOBOT_j2 = "关节2";
Blockly.Msg.DOBOT_j3 = "关节3";
Blockly.Msg.DOBOT_j4 = "关节4";
Blockly.Msg.DOBOT_j1Velocity = "关节1速度";
Blockly.Msg.DOBOT_j2Velocity = "关节2速度";
Blockly.Msg.DOBOT_j3Velocity = "关节3速度";
Blockly.Msg.DOBOT_j4Velocity = "关节4速度";
Blockly.Msg.DOBOT_j1Acceleration = "关节1加速度";
Blockly.Msg.DOBOT_j2Acceleration = "关节2加速度";
Blockly.Msg.DOBOT_j3Acceleration = "关节3加速度";
Blockly.Msg.DOBOT_j4Acceleration = "关节4加速度";
...
Blockly.Msg.DOBOT_value = "数值";
Blockly.Msg.DOBOT_type = "类型";

Blockly.Msg.DOBOT_THRESHOLD = "阈值";
Blockly.Msg.DOBOT_ANGLEUNIT = "度";
Blockly.Msg.DOBOT_SETLOSTSTEPPARAMS_TOOLTIP = "设置丢步参数";
Blockly.Msg.DOBOT_SETLOSTSTEPCMD_TOOLTIP = "丢步检测";
Blockly.Msg.DOBOT_SETINFRAREDSENEOR = "设置红外传感器";
Blockly.Msg.DOBOT_SETINFRAREDSENEOR_TOOLTIP = "设置红外传感器";
Blockly.Msg.DOBOT_GETINFRAREDSENEOR = "获取红外传感器";
Blockly.Msg.DOBOT_GETINFRAREDSENEOR_TOOLTIP = "获取红外传感器";
Blockly.Msg.Dobot_DISTANCE = "距离";
Blockly.Msg.Dobot_IO_INPUT_3V = "输入 3.3V";
Blockly.Msg.Dobot_IO_INPUT_5V = "输入 5V";
Blockly.Msg.Dobot_IO_ADC = "输入 AD";
Blockly.Msg.Dobot_IO_OUTPUT_3V = "输出 3.3V";
Blockly.Msg.Dobot_IO_OUTPUT_5V = "输出 5V";
Blockly.Msg.Dobot_IO_OUTPUT_12V = "输出 12V";
Blockly.Msg.Dobot_IO_PWM = "输出 PWM";
Blockly.Msg.DOBOT_ACCELERATION = "加速度";
Blockly.Msg.DOBOT_VELOCITY = "速度";


//2017-07-03
Blockly.Msg.DOBOT_SET_JOINT_SPEED = "设置轴速度";
Blockly.Msg.DOBOT_SET_JOINT_SPEED_TOOLTIP = "设置轴速度";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED = "设置运动比例";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED_TOOLTIP = "设置运动比例";
Blockly.Msg.DOBOT_VELOCITY_RATIO = "速度比例";
Blockly.Msg.DOBOT_ACCELERATION_RATIO = "加速度比例";
Blockly.Msg.DOBOT_SET_MOTOR = "设置电机速度";
Blockly.Msg.DOBOT_SET_MOTOR_TOOLTIP = "设置电机速度";
Blockly.Msg.DOBOT_SET_MOTORS = "设置电机速度和移动距离";
Blockly.Msg.DOBOT_SET_MOTORS_TOOLTIP = "设置电机速度和距离";
Blockly.Msg.DOBOT_GOTO = "移动到";
Blockly.Msg.DOBOT_GOTO_TOOLTIP = "移动到一个绝对笛卡尔坐标位置";
Blockly.Msg.DOBOT_JUMPTO = "门型运动到";
Blockly.Msg.DOBOT_JUMPTO_TOOLTIP = "门型运动到一个绝对笛卡尔坐标位置";
Blockly.Msg.DOBOT_MOVE = "相对移动";
Blockly.Msg.DOBOT_MOVE_TOOLTIP = "相对移动一个相对笛卡尔坐标增量";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE = "设置轴角度";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE_TOOLTIP = "设置轴角度";
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR = "设置光电传感器";
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR_TOOLTIP = "设置光电传感器";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR = "获取光电传感器数值";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR_TOOLTIP = "检测传感器前方一定距离是否有物体，有物体时为1；没有物体时为0；";
Blockly.Msg.DOBOT_SET_COLORSENEOR= "设置颜色传感器";
Blockly.Msg.DOBOT_SET_COLORSENEOR_TOOLTIP = "设置颜色传感器";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "识别颜色";
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "用于识别3种基本的颜色：蓝色、绿色、红色。当检测该颜色时返回1，否则返回0。";
Blockly.Msg.DOBOT_SET_CONVEYOR = "设置传送带";
Blockly.Msg.DOBOT_SET_CONVEYOR_TOOLTIP = "设置传送带";
Blockly.Msg.DOBOT_SET_LINEAR_RAIL = "设置滑轨";
Blockly.Msg.DOBOT_SET_LINEAR_RAIL_TOOLTIP = "设置滑轨";
Blockly.Msg.DOBOT_SETL = "移动滑轨到";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "移动滑轨到一个绝对笛卡尔坐标位置";
Blockly.Msg.DOBOT_SET_L_SPEED = "设置滑轨速度";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "设置滑轨的速度和加速度";
Blockly.Msg.DOBOT_POWER = "功率";
Blockly.Msg.DOBOT_LASER = "激光";
Blockly.Msg.DOBOT_LASER_TOOLTIP = "激光";
Blockly.Msg.DOBOT_SET_OUTPUT12V = "设置12V输出  ";
Blockly.Msg.DOBOT_SET_OUTPUT12V_TOOLTIP = "设置12V输出";
Blockly.Msg.DOBOT_SET_OUTPUT= "设置电平输出  ";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "设置电平输出";
Blockly.Msg.DOBOT_GET_INPUT_EIO= "获取电平输入  ";
Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "获取电平输入";
Blockly.Msg.DOBOT_SET_PWM = "设置PWM输出  ";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "设置PWM输出";
Blockly.Msg.DOBOT_GET_ADC = "获取AD输入  ";
Blockly.Msg.DOBOT_GET_ADC_TOOLTIP = "获取AD输入";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING= "设置EIO类型";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING_TOOLTIP = "设置EIO类型";


//2017-09-27
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED = "设置坐标系速度";
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED_TOOLTIP = "设置坐标系速度";

//2018-04-21
Blockly.Msg.DOBOT_SET_OUTPUT5V = "设置5V输出  ";
Blockly.Msg.DOBOT_SET_OUTPUT5V_TOOLTIP = "设置5V输出";
...
Blockly.Msg.DOBOT_DevType = "设备";

//2019-08-22
Blockly.Msg.DOBOT_Set_SeeedRgbLED = "设置RgbLed颜色";
Blockly.Msg.DOBOT_Set_SeeedRgbLED_TOOLTIP = "设置RgbLed颜色";
Blockly.Msg.DOBOT_Get_SeeedColorSensor = "识别颜色";
Blockly.Msg.DOBOT_Get_SeeedColorSensor_TOOLTIP = "识别颜色";
Blockly.Msg.DOBOT_Set_SeeedColorSensor = "设置颜色传感器";
Blockly.Msg.DOBOT_Set_SeeedColorSensor_TOOLTIP = "设置颜色传感器";
Blockly.Msg.DOBOT_Get_SeeedInfraredSensor = "获取光电传感器数值";
Blockly.Msg.DOBOT_Get_SeeedInfraredSensor_TOOLTIP = "获取光电传感器数值";
Blockly.Msg.DOBOT_Set_SeeedInfraredSensor = "设置光电传感器";
Blockly.Msg.DOBOT_Set_SeeedInfraredSensor_TOOLTIP = "设置光电传感器";
Blockly.Msg.DOBOT_Get_SeeedTemperatureSensor = "获取温湿度传感器数值";
Blockly.Msg.DOBOT_Get_SeeedTemperatureSensor_TOOLTIP = "获取温湿度传感器数值";
Blockly.Msg.DOBOT_Set_SeeedTemperatureSensor = "设置温湿度传感器";
Blockly.Msg.DOBOT_Set_SeeedTemperatureSensor_TOOLTIP = "设置温湿度传感器";
Blockly.Msg.DOBOT_Get_SeeedDistanceSensor = "获取超声波传感器测量数值";
Blockly.Msg.DOBOT_Get_SeeedDistanceSensor_TOOLTIP = "获取超声波传感器测量数值";

//2019-11-06
Blockly.Msg.DOBOT_GET_ENDEFFECTORTYPE = "获取末端类型";
Blockly.Msg.DOBOT_GET_ENDEFFECTORTYPE_TOOLTIP = "获取末端类型";
Blockly.Msg.DOBOT_SET_SERVOANGLE = "设置舵机角度";
Blockly.Msg.DOBOT_SET_SERVOANGLE_TOOLTIP = "设置舵机角度";
Blockly.Msg.DOBOT_SERVO_PORT = "舵机";
Blockly.Msg.DOBOT_SERVO_ANGLE_VALUE = "角度值";
Blockly.Msg.DOBOT_GET_SERVOANGLE = "获取舵机角度";
Blockly.Msg.DOBOT_GET_SERVOANGLE_TOOLTIP = "获取舵机角度";
// Blockly.Msg.DOBOT_SERVO_ANGLE = "度";
Blockly.Msg.DOBOT_SET_ARM_SPEED_RATIO = "设置机械臂速度比例";
Blockly.Msg.DOBOT_SET_ARM_SPEED_RATIO_TOOLTIP = "设置机械臂速度比例";
Blockly.Msg.DOBOT_SET_ARM_SPEED_MODE = "运动模式";
Blockly.Msg.DOBOT_SET_ARM_SPEED_MODE_JOG = "JOG";
Blockly.Msg.DOBOT_SET_ARM_SPEED_MODE_OTHER = "OTHER";
Blockly.Msg.DOBOT_GET_ARM_SPEED_RATIO = "获取机械臂速度比例";
Blockly.Msg.DOBOT_GET_ARM_SPEED_RATIO_TOOLTIP = "获取机械臂速度比例";
Blockly.Msg.DOBOT_SET_LinearRail_SPEED_MODE = "运动模式";
Blockly.Msg.DOBOT_SET_LinearRail_SPEED_MODE_JOG = "JOG";
Blockly.Msg.DOBOT_SET_LinearRail_SPEED_MODE_PTP = "PTP";
Blockly.Msg.DOBOT_SET_Liner_SPEED_RATIO = "设置滑轨速度比例";
Blockly.Msg.DOBOT_SET_Liner_SPEED_RATIO_TOOLTIP = "设置滑轨速度比例";
Blockly.Msg.DOBOT_GET_Liner_SPEED_RATIO = "获取滑轨速度比例";
Blockly.Msg.DOBOT_GET_Liner_SPEED_RATIO_TOOLTIP = "获取滑轨速度比例";
Blockly.Msg.DOBOT_SET_PROGBAR = "设置OLED进度条";
Blockly.Msg.DOBOT_SET_PROGBAR_VALUE = "进度值";
Blockly.Msg.DOBOT_SET_PROGBAR_TOOLTIP = "设置OLED进度条百分比";
Blockly.Msg.DOBOT_SET_PRINTINFO = "设置OLED显示信息";
Blockly.Msg.DOBOT_SET_PRINTINFO_VALUE = "显示信息";
Blockly.Msg.DOBOT_SET_PRINTINFO_TOOLTIP = "设置OLED显示信息";
Blockly.Msg.ADDPOINT = "添加坐标";