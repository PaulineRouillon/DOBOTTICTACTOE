...
Blockly.Msg.DOBOT_ON = "AN";
Blockly.Msg.DOBOT_OFF = "AUS";
Blockly.Msg.Dobot_Speed = "Geschwindigkeit";
Blockly.Msg.Dobot_DELTAPULSE = "DeltaPulse";
Blockly.Msg.DOBOT_ENABELD = "Aktiviert";
Blockly.Msg.DOBOT_GripperON = "Greifer";
Blockly.Msg.DOBOT_GripperOff = "Loslassen";										  
Blockly.Msg.DOBOT_GripperPROHIBIT = "Disable";											  
Blockly.Msg.DOBOT_BASEIC_HOME = "Home";
Blockly.Msg.DOBOT_BASEIC_HOME_TOOLTIP = "Home";
Blockly.Msg.DOBOT_BASEIC_TIME = "Zeit angeben";
Blockly.Msg.DOBOT_BASEIC_TIME_TOOLTIP = "Zeit angeben, Einheit:s";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE = "Aufsätze auswählen";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_TOOLTIP = "Aufsätze auswählen";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_SUCTIONCAP = "Sauggreifer";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_GRIPPER = "Greifer";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_LASER = "Laser";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_PEN = "Stift";
Blockly.Msg.DOBOT_CREAT_NEWTOOLS = "Neue Aufsätze erstellen"; 
Blockly.Msg.DOBOT_CREAT_NEWTOOLS_TOOLTIP = "Neue Aufsätze erstellen";
Blockly.Msg.DOBOT_SET_JOINT_SPEED = "Gelenkgeschwindigkeit einstellen";
Blockly.Msg.DOBOT_SET_JOINT_SPEED_TOOLTIP = "Gelenkgeschwindigkeit einstellen";
Blockly.Msg.DOBOT_SET_L_SPEED = "L Geschwindigkeit einstellen";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "L Geschwindigkeit einstellen";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT = "Jump Höhe einstellen";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT_TOOLTIP = "Jump Höhe einstellen";
Blockly.Msg.DOBOT_GOTO = "Gehe zu";
Blockly.Msg.DOBOT_GOTO_TOOLTIP = "Gehe zu";
Blockly.Msg.DOBOT_JUMPTO = "Spinge zu";
Blockly.Msg.DOBOT_JUMPTO_TOOLTIP = "Spinge zu";
Blockly.Msg.DOBOT_MOVE = "Bewegen";
Blockly.Msg.DOBOT_MOVE_TOOLTIP = "Bewegen";
Blockly.Msg.DOBOT_SETR = "R einstellen";
Blockly.Msg.DOBOT_SETR_TOOLTIP = "R einstellen";
Blockly.Msg.DOBOT_SETL = "L einstellen";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "L einstellen";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE = "Gelenkwinkel einstellen";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE_TOOLTIP = "Gelenkwinkel einstellen";
Blockly.Msg.DOBOT_SUCTIONCAP = "Sauggreifer";
Blockly.Msg.DOBOT_SUCTIONCAP_TOOLTIP = "Sauggreifer";
Blockly.Msg.DOBOT_GRIPPER = "Greifer";
Blockly.Msg.DOBOT_GRIPPER_TOOLTIP = "Greifer";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE= "Aktuelle Koordinate angeben";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE_TOOLTIP = "Aktuelle Koordinate angeben";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE= "Aktuellen Gelenkwinkel angeben";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE_TOOLTIP = "Aktuellen Gelenkwinkel angeben";
Blockly.Msg.DOBOT_DELAYTIME= "Verzögerungszeit";
Blockly.Msg.DOBOT_DELAYTIME_TOOLTIP = "Verzögerungszeit";
Blockly.Msg.DOBOT_MOTOR = "Motor";
Blockly.Msg.DOBOT_SET_MOTOR = "Emotor einstellen";
Blockly.Msg.DOBOT_SET_MOTOR_TOOLTIP = "Emotor einstellen";
Blockly.Msg.DOBOT_SET_MOTORS = "EmotorS einstellen";
Blockly.Msg.DOBOT_SET_MOTORS_TOOLTIP = "EmotorS einstellen";
Blockly.Msg.DOBOT_SET_PWM = "PMW einstellen";
Blockly.Msg.DOBOT_Value = "Wert";
Blockly.Msg.DOBOT_FREQUENCY = "Frequenz";
Blockly.Msg.DOBOT_DUTYCYCLE = "Auslastungsgrad";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "PMW einstellen";
Blockly.Msg.DOBOT_GET_PWM = "PMW angeben";
Blockly.Msg.DOBOT_GET_PWM_TOOLTIP = "PMW angeben";
Blockly.Msg.DOBOT_GET_ADC = "AD erhalten";
Blockly.Msg.DOBOT_GET_INPUT_EIO= "Input EIO erhalten";
Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "Input EIO erhalten";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING= "IOMultiplexing einstellen";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING_TOOLTIP = "IOMultiplexing einstellen";
Blockly.Msg.DOBOT_SET_OUTPUT= "Output einstellen";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "Output einstellen";
Blockly.Msg.DOBOT_SET_COLORSENEOR= "Farbsensor einstellen";
Blockly.Msg.DOBOT_SET_COLORSENEOR_TOOLTIP = "Farbsensor einstellen";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "Farbe auslesen";
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "Farbe auslesen";
Blockly.Msg.DOBOT_GET_12OUTPUT= "12V Output erhalten";
Blockly.Msg.DOBOT_GET_12OUTPUT_TOOLTIP = "12V Output erhalten";
...
Blockly.Msg.DOBOT_xBias = "xAusrichtung";
Blockly.Msg.DOBOT_yBias = "yAusrichtung";
Blockly.Msg.DOBOT_zBias = "zAusrichtung";
Blockly.Msg.DOBOT_j1 = "j1";
Blockly.Msg.DOBOT_j2 = "j2";
Blockly.Msg.DOBOT_j3 = "j3";
Blockly.Msg.DOBOT_j4 = "j4";
Blockly.Msg.DOBOT_j1Velocity = "j1Geschwindigkeit";
Blockly.Msg.DOBOT_j2Velocity = "j2Geschwindigkeit";
Blockly.Msg.DOBOT_j3Velocity = "j3Geschwindigkeit";
Blockly.Msg.DOBOT_j4Velocity = "j4Geschwindigkeit";
Blockly.Msg.DOBOT_j1Acceleration = "j1Beschleunigung";
Blockly.Msg.DOBOT_j2Acceleration = "j2Beschleunigung";
Blockly.Msg.DOBOT_j3Acceleration = "j3Beschleunigung";
Blockly.Msg.DOBOT_j4Acceleration = "j4Beschleunigung";
Blockly.Msg.DOBOT_height = "Höhe";
Blockly.Msg.DOBOT_lVelocity = "lGeschwindigkeit";
Blockly.Msg.DOBOT_lAcceleration = "lBeschleunigung";
Blockly.Msg.DOBOT_velocityRatio = "Geschwindigkeitsverhältnis";
Blockly.Msg.DOBOT_accelerationRatio = "Beschleunigkeitsverhältnis";
Blockly.Msg.DOBOT_value = "value";
Blockly.Msg.DOBOT_type = "Art";

Blockly.Msg.DOBOT_THRESHOLD = "Schwelle";
Blockly.Msg.DOBOT_ANGLEUNIT = "Grad";
Blockly.Msg.DOBOT_SETLOSTSTEPPARAMS_TOOLTIP = "Set Params Verloren Gehen";
Blockly.Msg.DOBOT_SETLOSTSTEPCMD_TOOLTIP = "Überprüfen Sie Den Verlorenen Schritt";
Blockly.Msg.Dobot_DISTANCE = "Entfernung";
Blockly.Msg.Dobot_IO_INPUT_3V = "Eingang 3.3V";
Blockly.Msg.Dobot_IO_INPUT_5V = "Eingang 5V";
Blockly.Msg.Dobot_IO_ADC = "Eingang ADC";
Blockly.Msg.Dobot_IO_OUTPUT_3V = "Ausgabe 3.3V";
Blockly.Msg.Dobot_IO_OUTPUT_5V = "Ausgabe 5V";
Blockly.Msg.Dobot_IO_OUTPUT_12V = "Ausgabe 12V";
Blockly.Msg.Dobot_IO_PWM = "Ausgabe PWM";
Blockly.Msg.DOBOT_ACCELERATION = "Beschleunigung";
Blockly.Msg.DOBOT_VELOCITY = "Geschwindigkeit";

//2017-07-03
Blockly.Msg.DOBOT_SET_JOINT_SPEED = "SetJointSpeed";
Blockly.Msg.DOBOT_SET_JOINT_SPEED_TOOLTIP = "Set Joint Speed";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED = "Bewegung Verhältnis Einstellen";													 																
Blockly.Msg.DOBOT_SET_LINEAR_SPEED_TOOLTIP = "Bewegung Verhältnis Einstellen";
Blockly.Msg.DOBOT_VELOCITY_RATIO = "Geschwindigkeit Verhältnis";
Blockly.Msg.DOBOT_ACCELERATION_RATIO = "Beschleunigung Verhältnis";
Blockly.Msg.DOBOT_SET_MOTOR = "Motor Geschwindigkeit Einstellen"
Blockly.Msg.DOBOT_SET_MOTOR_TOOLTIP = "Motor Geschwindigkeit Einstellen"																	 
Blockly.Msg.DOBOT_SET_MOTORS = "Motor Geschwindigkeit Und Distanz Einstellen"
Blockly.Msg.DOBOT_SET_MOTORS_TOOLTIP = "Motor Geschwindigkeit Und Distanz Einstellen"
...
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR = "Photoelektrischen Sensor Einstellen";															 																		   
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR_TOOLTIP = "Photoelektrischen Sensor Einstellen";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR = "Photoelektrischen Sensor Erhalten";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR_TOOLTIP = "Erkennung von Sensoren vor einer gewissen Distanz, ob es ein Objekt gibt, gibt es Objekte für 1; Kein Objekt für 0.";
Blockly.Msg.DOBOT_SET_COLORSENEOR= "SetColorSensor";
Blockly.Msg.DOBOT_SET_COLORSENEOR_TOOLTIP = "Set Color Sensor";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "Farbe Identifizieren";												   																																							
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "Zur Identifizierung von 3 Grundfarben: blau, grün und rot. Gibt 1 beim Erfassen der Farbe zurück oder gibt 0 zurück.";
Blockly.Msg.DOBOT_SET_CONVEYOR = "Förderband Einstellen"
Blockly.Msg.DOBOT_SET_CONVEYOR_TOOLTIP = "Förderband Einstellen"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL = "Lineare Schiene Einstellen"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL_TOOLTIP = "Lineare Schiene Einstellen"
Blockly.Msg.DOBOT_SETL = "Lineare Schiene Bewegen";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "Lineare Schiene Bewegen";
Blockly.Msg.DOBOT_SET_L_SPEED = "Lineare Schiene Geschwindigkeit Einstellen";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "Lineare Schiene Geschwindigkeit Einstellen";
Blockly.Msg.DOBOT_POWER = "Leistung";
Blockly.Msg.DOBOT_LASER = "Laser";
Blockly.Msg.DOBOT_LASER_TOOLTIP = "Laser";
Blockly.Msg.DOBOT_SET_OUTPUT12V = "Ausgabe 12V Einstellen  ";
Blockly.Msg.DOBOT_SET_OUTPUT12V_TOOLTIP = "Ausgabe 12V Einstellen";
Blockly.Msg.DOBOT_SET_OUTPUT= "Ausgabe Ebene Einstellen  ";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "Ausgabe Ebene Einstellen";
Blockly.Msg.DOBOT_GET_INPUT_EIO= "Eingang Ebene Erhalten  ";
Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "Eingang Ebene Erhalten";
Blockly.Msg.DOBOT_SET_PWM = "Ausgabe PWM Einstellen  ";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "Ausgabe PWM Einstellen";
Blockly.Msg.DOBOT_GET_PWM = "Eingang PWM Erhalten  ";
Blockly.Msg.DOBOT_GET_PWM_TOOLTIP = "Eingang PWM Erhalten";
Blockly.Msg.DOBOT_GET_ADC = "Eingang AD Erhalten  ";
Blockly.Msg.DOBOT_GET_ADC_TOOLTIP = "Eingang AD Erhalten";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING= "SetIOMultiplexing";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING_TOOLTIP = "SetIOMultiplexing";

//2017-09-27
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED = "DieKoordinatenDerGeschwindigkeit";
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED_TOOLTIP = "Die koordinaten der Geschwindigkeit";
