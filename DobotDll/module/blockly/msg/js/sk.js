...
Blockly.Msg.DOBOT_ON = "Zapnúť";
Blockly.Msg.DOBOT_OFF = "Vypnúť";
Blockly.Msg.Dobot_Speed = "Rýchlosť";
Blockly.Msg.Dobot_DELTAPULSE = "Delta Impulz"
Blockly.Msg.DOBOT_ENABELD = "Je Aktivované";
Blockly.Msg.DOBOT_GripperON = "Zverák";
Blockly.Msg.DOBOT_GripperOff = "Uvolniť";
Blockly.Msg.DOBOT_GripperPROHIBIT = "Disable";											  
Blockly.Msg.DOBOT_BASEIC_HOME = "Domov";
Blockly.Msg.DOBOT_BASEIC_HOME_TOOLTIP = "Domov";
Blockly.Msg.DOBOT_BASEIC_TIME = "GetTime";
Blockly.Msg.DOBOT_BASEIC_TIME_TOOLTIP = "ZískaťČas, jenotka:s";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE = "Zvoľ koncové zariadenie";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_TOOLTIP = "Zvoľ koncové zariadenie";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_SUCTIONCAP = "Prísavný Držiak";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_GRIPPER = "Zverák";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_LASER = "Laser";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_PEN = "Pero";
...
Blockly.Msg.DOBOT_SET_JOINT_SPEED = "Zadaj rýchlosť kĺbu";
Blockly.Msg.DOBOT_SET_JOINT_SPEED_TOOLTIP = "Zadaj rýchlosť kĺbu";
Blockly.Msg.DOBOT_SET_L_SPEED = "Zadaj rýchlosť L";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "Zadaj rýchlosť L";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED = "Zadaj lineárnu rýchlosť";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED_TOOLTIP = "Zadaj lineárnu rýchlosť";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT = "Zadaj výšku skoku";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT_TOOLTIP = "Zadaj výšku skoku";
Blockly.Msg.DOBOT_GOTO = "Choď na";
Blockly.Msg.DOBOT_GOTO_TOOLTIP = "Choď na";
Blockly.Msg.DOBOT_JUMPTO = "Skoč na";
Blockly.Msg.DOBOT_JUMPTO_TOOLTIP = "Skoč na";
Blockly.Msg.DOBOT_MOVE = "Presuň";
Blockly.Msg.DOBOT_MOVE_TOOLTIP = "Presuň";
Blockly.Msg.DOBOT_SETR = "Zadaj R";
Blockly.Msg.DOBOT_SETR_TOOLTIP = "Zadaj R";
Blockly.Msg.DOBOT_SETL = "Zadaj L";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "Zadaj L";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE = "Zadaj uhol kĺbu";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE_TOOLTIP = "Zadaj uhol kĺbu";
Blockly.Msg.DOBOT_SUCTIONCAP = "Prísavný Držiak";
Blockly.Msg.DOBOT_SUCTIONCAP_TOOLTIP = "Prísavný Držiak";
Blockly.Msg.DOBOT_GRIPPER = "Zverák";
Blockly.Msg.DOBOT_GRIPPER_TOOLTIP = "Zverák";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE= "Získaj aktuálne koordináty";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE_TOOLTIP = "Získaj aktuálne koordináty";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE= "Získaj uhol kĺbu";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE_TOOLTIP = "Získaj uhol kĺbu";
Blockly.Msg.DOBOT_DELAYTIME= "Oneskorenie";
Blockly.Msg.DOBOT_DELAYTIME_TOOLTIP = "Oneskorenie";
Blockly.Msg.DOBOT_MOTOR = "Motor"
Blockly.Msg.DOBOT_SET_MOTOR = "NastavMotor"
Blockly.Msg.DOBOT_SET_MOTOR_TOOLTIP = "Nastav EMotor"
Blockly.Msg.DOBOT_SET_MOTORS = "NastavEMotorS"
Blockly.Msg.DOBOT_SET_MOTORS_TOOLTIP = "Nastav EMotorS"
Blockly.Msg.DOBOT_SET_PWM = "Zadaj PWM";
Blockly.Msg.DOBOT_Value = "hodnota";
Blockly.Msg.DOBOT_FREQUENCY = "frekvencia";
Blockly.Msg.DOBOT_DUTYCYCLE = "Cyklus";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "Zadaj PWM";
Blockly.Msg.DOBOT_GET_PWM = "Získaj PWM";
Blockly.Msg.DOBOT_GET_PWM_TOOLTIP = "Získaj PWM";
Blockly.Msg.DOBOT_GET_ADC = "Získaj ADC";
Blockly.Msg.DOBOT_GET_INPUT_EIO= "Získaj Vstup  EIO";
Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "Získaj Vstup  EIO";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING= "Zadaj I/O Multiplexovanie";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING_TOOLTIP = " Zadaj I/O Multiplexovanie ";
Blockly.Msg.DOBOT_SET_OUTPUT= "Zadaj Výstup";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "Zadaj Výstup";
Blockly.Msg.DOBOT_SET_COLORSENEOR= "Zadaj senzor farieb";
Blockly.Msg.DOBOT_SET_COLORSENEOR_TOOLTIP = "Zadaj senzor farieb";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "Získaj Farbu";
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "Získaj Farbu";
Blockly.Msg.DOBOT_GET_12OUTPUT= "Získaj Výstup 12V";
Blockly.Msg.DOBOT_GET_12OUTPUT_TOOLTIP = "Získaj Výstup 12V";

Blockly.Msg.DOBOT_joint1 = "Kĺb1";
Blockly.Msg.DOBOT_joint2 = "Kĺb2";
Blockly.Msg.DOBOT_joint3 = "Kĺb3";
Blockly.Msg.DOBOT_joint4 = "Kĺb4";
Blockly.Msg.DOBOT_covery = "L";							   
Blockly.Msg.DOBOT_xBias = "XOdchylka";
Blockly.Msg.DOBOT_yBias = "YOdchylka";
Blockly.Msg.DOBOT_zBias = "ZOdchylka";
Blockly.Msg.DOBOT_j1 = "Kĺb1";
Blockly.Msg.DOBOT_j2 = "Kĺb2";
Blockly.Msg.DOBOT_j3 = "Kĺb3";
Blockly.Msg.DOBOT_j4 = "Kĺb4";
Blockly.Msg.DOBOT_j1Velocity = "Kĺb1Rýchlosť";
Blockly.Msg.DOBOT_j2Velocity = "Kĺb2Rýchlosť";
Blockly.Msg.DOBOT_j3Velocity = "Kĺb3Rýchlosť";
Blockly.Msg.DOBOT_j4Velocity = "Kĺb4Rýchlosť";
Blockly.Msg.DOBOT_j1Acceleration = "Kĺb1Zrýchlenie";
Blockly.Msg.DOBOT_j2Acceleration = "Kĺb2Zrýchlenie";
Blockly.Msg.DOBOT_j3Acceleration = "Kĺb3Zrýchlenie";
Blockly.Msg.DOBOT_j4Acceleration = "Kĺb4Zrýchlenie";
Blockly.Msg.DOBOT_height = "výška";
Blockly.Msg.DOBOT_lVelocity = "lRýchlosť";
Blockly.Msg.DOBOT_lAcceleration = "lZrýchlenie";
Blockly.Msg.DOBOT_velocityRatio = "PomerRýchlosti"
Blockly.Msg.DOBOT_accelerationRatio = "PomerZrýchlenia"
Blockly.Msg.DOBOT_value = "Hodnota";
Blockly.Msg.DOBOT_type = "Typ";

Blockly.Msg.DOBOT_THRESHOLD = "Prah";
Blockly.Msg.DOBOT_ANGLEUNIT = "Stupeň";
Blockly.Msg.DOBOT_SETLOSTSTEPPARAMS_TOOLTIP = "Nastaviť Parametre Stratených Krokov";
Blockly.Msg.DOBOT_SETLOSTSTEPCMD_TOOLTIP = "Kontrola Strateného Kroku";
Blockly.Msg.Dobot_DISTANCE = "Vzdialenosť";
Blockly.Msg.Dobot_IO_INPUT_3V = "Vstup 3.3V";
Blockly.Msg.Dobot_IO_INPUT_5V = "Vstup 5V";
Blockly.Msg.Dobot_IO_ADC = "Vstup AD";
Blockly.Msg.Dobot_IO_OUTPUT_3V = "Výkon 3.3V";
Blockly.Msg.Dobot_IO_OUTPUT_5V = "Výkon 5V";
Blockly.Msg.Dobot_IO_OUTPUT_12V = "Výkon 12V";
Blockly.Msg.Dobot_IO_PWM = "Výkon PWM";
Blockly.Msg.DOBOT_ACCELERATION = "Akcelerácia";
Blockly.Msg.DOBOT_VELOCITY = "Rýchlosť";
	
//2017-07-03
Blockly.Msg.DOBOT_SET_LINEAR_SPEED = "Nastavte Pomer Pohybu";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED_TOOLTIP = "Nastavte Pomer Pohybu";
Blockly.Msg.DOBOT_VELOCITY_RATIO = "Pomer Rýchlosti";
Blockly.Msg.DOBOT_ACCELERATION_RATIO = "Pomer Zrýchlenia";
Blockly.Msg.DOBOT_SET_MOTOR = "Nastavte Rýchlosti Motora"
Blockly.Msg.DOBOT_SET_MOTOR_TOOLTIP = "Nastavte Rýchlosti Motora"
Blockly.Msg.DOBOT_SET_MOTORS = "Nastavte Rýchlosti A Vzdialenosť Motora"
Blockly.Msg.DOBOT_SET_MOTORS_TOOLTIP = "Nastavte Rýchlosti A Vzdialenosť Motora"
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR = "Nastavte Fotoelektrický Snímač";
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR_TOOLTIP = "Nastavte Fotoelektrický Snímač";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR = "Získajte Fotoelektrický Snímač";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR_TOOLTIP = "Detekcia snímačov pred určitou vzdialenosťou, či existuje objekt, sú objekty pre 1; Žiadny objekt pre 0.";
Blockly.Msg.DOBOT_SET_COLORSENEOR= "Nastavte Senzor Farieb";
Blockly.Msg.DOBOT_SET_COLORSENEOR_TOOLTIP = "Nastavte Senzor Farieb";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "Identifikovať Farbu";
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "Používa sa na identifikáciu 3 základných farieb: modrej, zelenej a červenej farby. Vráti 1 pri detekcii farby, inak vráti 0.";
Blockly.Msg.DOBOT_SET_CONVEYOR = "Nastavte Dopravník"
Blockly.Msg.DOBOT_SET_CONVEYOR_TOOLTIP = "Nastavte Dopravník"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL = "Nastavte Lineárnu Lištu"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL_TOOLTIP = "Nastavte Lineárnu Lištu"
Blockly.Msg.DOBOT_SETL = "Presunúť Lineárnu Lištu Do";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "Presunúť Lineárnu Lištu Do";
Blockly.Msg.DOBOT_SET_L_SPEED = "Nastavte Rýchlosť Lineárneho Vedenia";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "Nastavte Rýchlosť Lineárneho Vedenia";
Blockly.Msg.DOBOT_POWER = "Moc";
Blockly.Msg.DOBOT_LASER = "Laser";
Blockly.Msg.DOBOT_LASER_TOOLTIP = "Laser";
Blockly.Msg.DOBOT_SET_OUTPUT12V = "Nastavte 12V Výkon  ";
Blockly.Msg.DOBOT_SET_OUTPUT12V_TOOLTIP = "Nastavte 12V Výkon";
Blockly.Msg.DOBOT_SET_OUTPUT= "Nastavte Leavel Výkon  ";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "Nastavte Leavel Výkon";
Blockly.Msg.DOBOT_GET_INPUT_EIO= "Dostať Leavel Vstup  ";
Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "Dostať Leavel Vstup";
Blockly.Msg.DOBOT_SET_PWM = "Nastavte PWM Výkon  ";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "Nastavte PWM Výkon";
Blockly.Msg.DOBOT_GET_PWM = "Dostať PWM Vstup  ";
Blockly.Msg.DOBOT_GET_PWM_TOOLTIP = "Dostať PWM Vstup";
Blockly.Msg.DOBOT_GET_ADC = "Dostať AD Vstup  ";
Blockly.Msg.DOBOT_GET_ADC_TOOLTIP = "Dostať AD Vstup";


//2017-09-27
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED = "NastavteRýchlosťSúradnicovéhoSystému";
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED_TOOLTIP = "Nastavte rýchlosť súradnicového systému";
