...
Blockly.Msg.DOBOT_ON = "オン";
Blockly.Msg.DOBOT_OFF = "オフ";
Blockly.Msg.Dobot_Speed = "スピード";
Blockly.Msg.Dobot_DELTAPULSE = "増分パルス"
Blockly.Msg.DOBOT_ENABELD = "有効になっています";
Blockly.Msg.DOBOT_GripperON = "掴む";
Blockly.Msg.DOBOT_GripperOff = "放す";
Blockly.Msg.DOBOT_GripperPROHIBIT = "Disable";											  
Blockly.Msg.DOBOT_BASEIC_HOME = "戻る";
Blockly.Msg.DOBOT_BASEIC_HOME_TOOLTIP = "戻る";
Blockly.Msg.DOBOT_BASEIC_TIME = "時間を得る";
Blockly.Msg.DOBOT_BASEIC_TIME_TOOLTIP = "時間を得る、ユニット：s";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE = "最後のツールと選ぶ";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_TOOLTIP = "最後のツールと選ぶ";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_SUCTIONCAP = "吸着カップ";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_GRIPPER = "グリッパー";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_LASER = "レーザー";
Blockly.Msg.DOBOT_BASEIC_SETENDTYPE_PEN = "ペン";
Blockly.Msg.DOBOT_CREAT_NEWTOOLS = "新しいツールを作成（Creat）する";
Blockly.Msg.DOBOT_CREAT_NEWTOOLS_TOOLTIP = "新しいツールを作成（Creat）する";
Blockly.Msg.DOBOT_SET_L_SPEED = "L軸速度設定";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "L軸速度設定";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT = "ジャンプの高さ設定する";
Blockly.Msg.DOBOT_SET_JUMP_HEIGHT_TOOLTIP = "ジャンプの高さ設定する";
Blockly.Msg.DOBOT_SETR = "Rを設定する";
Blockly.Msg.DOBOT_SETR_TOOLTIP = "Rを設定する";
Blockly.Msg.DOBOT_SETL = "L軸位置設定";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "L軸位置設定";
Blockly.Msg.DOBOT_SUCTIONCAP = "吸着カップ";
Blockly.Msg.DOBOT_SUCTIONCAP_TOOLTIP = "吸着カップ";
Blockly.Msg.DOBOT_GRIPPER = "掴む";
Blockly.Msg.DOBOT_GRIPPER_TOOLTIP = "掴む";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE= "現在の座標を取得する";
Blockly.Msg.DOBOT_GET_CURRETN_COORDINATE_TOOLTIP = "現在の座標を取得する";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE= "関節の角度を取得する";
Blockly.Msg.DOBOT_GET_CURRENT_ANGLE_TOOLTIP = "関節の角度を取得する";
Blockly.Msg.DOBOT_DELAYTIME= "ディレイタイム";
Blockly.Msg.DOBOT_DELAYTIME_TOOLTIP = "ディレイタイム";
Blockly.Msg.DOBOT_MOTOR = "モーター"
Blockly.Msg.DOBOT_SET_PWM = "PWMを設定する";
Blockly.Msg.DOBOT_Value = "値";
Blockly.Msg.DOBOT_FREQUENCY = "周波数";
Blockly.Msg.DOBOT_DUTYCYCLE = "デューティ周期";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "PWMを設定する";
Blockly.Msg.DOBOT_GET_PWM = "PWMを取得する";
Blockly.Msg.DOBOT_GET_PWM_TOOLTIP = "PWMを取得する";
Blockly.Msg.DOBOT_GET_ADC = "ADを取得する";
Blockly.Msg.DOBOT_GET_INPUT_EIO= "入力EIOを取得する";
Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "入力EIOを取得する";
Blockly.Msg.DOBOT_SET_OUTPUT= "出力を設定する";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "出力を設定する";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "色を得る";
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "色を得る";
Blockly.Msg.DOBOT_GET_12OUTPUT= "12V出力を設定する";
Blockly.Msg.DOBOT_GET_12OUTPUT_TOOLTIP = "12V出力を設定する";

Blockly.Msg.DOBOT_joint1 = "関節1";
Blockly.Msg.DOBOT_joint2 = "関節2";
Blockly.Msg.DOBOT_joint3 = "関節3";
Blockly.Msg.DOBOT_joint4 = "関節4";
Blockly.Msg.DOBOT_covery = "L";							   
Blockly.Msg.DOBOT_xBias = "Xずれ値";
Blockly.Msg.DOBOT_yBias = "Yずれ値";
Blockly.Msg.DOBOT_zBias = "Zずれ値";
Blockly.Msg.DOBOT_j1 = "関節1";
Blockly.Msg.DOBOT_j2 = "関節2";
Blockly.Msg.DOBOT_j3 = "関節3";
Blockly.Msg.DOBOT_j4 = "関節4";
Blockly.Msg.DOBOT_j1Velocity = "関節1速度";
Blockly.Msg.DOBOT_j2Velocity = "関節2速度";
Blockly.Msg.DOBOT_j3Velocity = "関節3速度";
Blockly.Msg.DOBOT_j4Velocity = "関節4速度";
Blockly.Msg.DOBOT_j1Acceleration = "関節1加速度";
Blockly.Msg.DOBOT_j2Acceleration = "関節2加速度";
Blockly.Msg.DOBOT_j3Acceleration = "関節3加速度";
Blockly.Msg.DOBOT_j4Acceleration = "関節4加速度";
Blockly.Msg.DOBOT_height = "高さ";
Blockly.Msg.DOBOT_lVelocity = "l速度";
Blockly.Msg.DOBOT_lAcceleration = "l加速度";
Blockly.Msg.DOBOT_velocityRatio = "速度の比率";
Blockly.Msg.DOBOT_accelerationRatio = "加速度の比率";
Blockly.Msg.DOBOT_value = "値";
Blockly.Msg.DOBOT_type = "タイプ";										

Blockly.Msg.DOBOT_THRESHOLD = "閾値";
Blockly.Msg.DOBOT_ANGLEUNIT = "度";
Blockly.Msg.DOBOT_SETLOSTSTEPPARAMS_TOOLTIP = "失われたステップのパラメータを設定する";
Blockly.Msg.DOBOT_SETLOSTSTEPCMD_TOOLTIP = "失われたステップを確認する";
Blockly.Msg.Dobot_DISTANCE = "距離";
Blockly.Msg.Dobot_IO_INPUT_3V = "入力 3.3V";
Blockly.Msg.Dobot_IO_INPUT_5V = "入力 5V";
Blockly.Msg.Dobot_IO_ADC = "入力 ADC";
Blockly.Msg.Dobot_IO_OUTPUT_3V = "出力 3.3V";
Blockly.Msg.Dobot_IO_OUTPUT_5V = "出力 5V";
Blockly.Msg.Dobot_IO_OUTPUT_12V = "出力 12V";
Blockly.Msg.Dobot_IO_PWM = "出力 PWM";
Blockly.Msg.DOBOT_ACCELERATION = "加速度";
Blockly.Msg.DOBOT_VELOCITY = "速度";

//2017-07-03
Blockly.Msg.DOBOT_SET_JOINT_SPEED = "関節スピードを設定する";
Blockly.Msg.DOBOT_SET_JOINT_SPEED_TOOLTIP = "関節スピードを設定する";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED = "運動比を設定する";
Blockly.Msg.DOBOT_SET_LINEAR_SPEED_TOOLTIP = "運動比を設定する";
Blockly.Msg.DOBOT_VELOCITY_RATIO = "速度割合";
Blockly.Msg.DOBOT_ACCELERATION_RATIO = "加速度割合";
Blockly.Msg.DOBOT_SET_MOTOR = "モータ速度を設定する"
Blockly.Msg.DOBOT_SET_MOTOR_TOOLTIP = "モータ速度を設定する"
Blockly.Msg.DOBOT_SET_MOTORS = "モータと距離を設定する"
Blockly.Msg.DOBOT_SET_MOTORS_TOOLTIP = "モータ速度と距離を設定する"
Blockly.Msg.DOBOT_GOTO = "ｘｘへ行く";
Blockly.Msg.DOBOT_GOTO_TOOLTIP = "ｘｘへ行く";
Blockly.Msg.DOBOT_JUMPTO = "へジャンプする";
Blockly.Msg.DOBOT_JUMPTO_TOOLTIP = "へジャンプする";
Blockly.Msg.DOBOT_MOVE = "移動";
Blockly.Msg.DOBOT_MOVE_TOOLTIP = "移動";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE = "関節の角度を設定する";
Blockly.Msg.DOBOT_SET_JOINT_ANGLE_TOOLTIP = "関節の角度を設定する";
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR = "光電センサの設定";
Blockly.Msg.DOBOT_SET_INFRARED_SENEOR_TOOLTIP = "光電センサの設定";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR = "光電センサを取得する";
Blockly.Msg.DOBOT_GET_INFRARED_SENEOR_TOOLTIP = "物体があるかどうかにかかわらず、ある距離の前にセンサを検出すると、1の物体が存在する。 0のオブジェクトはありません。";
Blockly.Msg.DOBOT_SET_COLORSENEOR= "カラーセンサーを設定する";
Blockly.Msg.DOBOT_SET_COLORSENEOR_TOOLTIP = "カラーセンサーを設定する";
Blockly.Msg.DOBOT_GET_COLORSENEOR= "色を識別する";
Blockly.Msg.DOBOT_GET_COLORSENEOR_TOOLTIP = "青、緑、赤の3つの基本色を識別するために使用されます。 色を検出すると1を返し、そうでない場合は0を返します。";
Blockly.Msg.DOBOT_SET_CONVEYOR = "コンベヤを設定する"
Blockly.Msg.DOBOT_SET_CONVEYOR_TOOLTIP = "コンベヤを設定する"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL = "リニアレールを設定する"
Blockly.Msg.DOBOT_SET_LINEAR_RAIL_TOOLTIP = "リニアレールを設定する"
Blockly.Msg.DOBOT_SETL = "リニアレール移動";
Blockly.Msg.DOBOT_SETL_TOOLTIP = "リニアレール移動";
Blockly.Msg.DOBOT_SET_L_SPEED = "リニアレール速度を設定する";
Blockly.Msg.DOBOT_SET_L_SPEED_TOOLTIP = "リニアレール速度を設定する";
Blockly.Msg.DOBOT_POWER = "パワー";
Blockly.Msg.DOBOT_LASER = "レーザ";
Blockly.Msg.DOBOT_LASER_TOOLTIP = "レーザ";
Blockly.Msg.DOBOT_SET_OUTPUT12V = "出力12Vを設定する  ";
Blockly.Msg.DOBOT_SET_OUTPUT12V_TOOLTIP = "出力12Vを設定する";
Blockly.Msg.DOBOT_SET_OUTPUT= "レベル出力を設定する  ";
Blockly.Msg.DOBOT_SET_OUTPUT_TOOLTIP = "レベル出力を設定する";
//Blockly.Msg.DOBOT_GET_INPUT_EIO= "取得レベル出力   EIO";
//Blockly.Msg.DOBOT_GET_INPUT_EIO_TOOLTIP = "取得レベル出力";
Blockly.Msg.DOBOT_SET_PWM = "PWM出力を設定する  ";
Blockly.Msg.DOBOT_SET_PWM_TOOLTIP = "PWM出力を設定する";
Blockly.Msg.DOBOT_GET_PWM = "取得PWM入力  ";
Blockly.Msg.DOBOT_GET_PWM_TOOLTIP = "取得PWM入力";
Blockly.Msg.DOBOT_GET_ADC = "取得AD入力  ";
Blockly.Msg.DOBOT_GET_ADC_TOOLTIP = "取得AD入力";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING= "入出力の多重化を設定する";
Blockly.Msg.DOBOT_SET_IOMULTIPLEXING_TOOLTIP = "入出力の多重化を設定する";
//2017-09-27
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED = "座標系の速度を設定する";
Blockly.Msg.DOBOT_SET_COORDINATE_SPEED_TOOLTIP = "座標系の速度を設定する";
