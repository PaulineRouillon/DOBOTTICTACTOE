...
def load():
    if platform.system() == "Windows":
        return CDLL("C:\\Users\\Clement\\Desktop\\Polytech\\D2I_4A\\Projet co\\DobotDemoV2.0\\DobotDemoForPython\\DobotDll.dll",  RTLD_GLOBAL) 
    elif platform.system() == "Darwin" :
        return CDLL("C:\\Users\\Clement\\Desktop\\Polytech\\D2I_4A\\Projet co\\DobotDemoV2.0\\DobotDemoForPython\\libDobotDll.dylib",  RTLD_GLOBAL)
    else:
        return cdll.loadLibrary("C:\\Users\\Clement\\Desktop\\Polytech\\D2I_4A\\Projet co\\DobotDemoV2.0\\DobotDemoForPython\\libDobotDll.so")
